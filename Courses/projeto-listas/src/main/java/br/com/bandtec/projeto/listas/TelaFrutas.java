...
public class TelaFrutas extends javax.swing.JFrame {
    ...
    List<String> frutas = 
        Arrays.asList("uva","maçã","pêra","abacaxi","banana");
    /**
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(tfPesquisa, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String resultado;
        if (frutas.indexOf(pesquisa)>=0) {
            resultado = "A fruta "+pesquisa+" existe na lista";
        } else {
            resultado = "Não existe a fruta "+pesquisa+" na lista";
        }
